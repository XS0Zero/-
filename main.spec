...
a = Analysis(
    ...
    pathex=['Project'],
    binaries=[],
    datas=[('matlab2','matlab2'),('resource','resource'),('ctrl','ctrl'),('F:\\Users\\12875\\anaconda3\\envs\\matlab\\Lib\\site-packages\\openpyxl','openpyxl'),('F:\\Users\\12875\\anaconda3\\envs\\matlab\\Lib\\site-packages\\matplotlib','matplotlib')],
    hiddenimports=['pkg_resources.extern','openpyxl','openpyxl.cell._writer','matplotlib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
